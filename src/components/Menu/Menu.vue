<template>
  <div class="flex w-full justify-between sm:(bg-base-self flex-col h-full border-r p-2)">
    <div class="flex flex-col-reverse w-full relative sm:block">
      ...
      >
        <div class="">
          <div class="p-1  divide-gray-400/20  rounded-xl backdrop-filter backdrop-blur-md shadow-sm overflow-hidden border border-gray-400/30">
            <button
          ...
          <div class="rounded-xl flex backdrop-filter backdrop-blur h-13 shadow-sm my-1.5 p-1 items-center justify-between border border-gray-400/30">
    ...
    <bottom-dialog ref="BottomDialog">
      <template #body> <div class="h-[40vh]"></div></template
    ></bottom-dialog>
  </div>
</template>
