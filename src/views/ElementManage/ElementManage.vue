      ...
      <template #entire>
        ...
        <form @submit="submit" @close="$refs.Dialog.closeModal()" class="mt-5">
          ...
          <div class="mt-4 flex justify-center">
            <button class="btn bg-warning text-warningContent mx-5 text-sm" type="close" @click="$refs.Dialog.closeModal()">取消</button>
            <button class="btn bg-primary text-primaryContent mx-5 text-sm" type="submit">确认</button>
          </div>
        </form>
      </template>
    </Dialog>
