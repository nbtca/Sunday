module.exports = {
  ...
  shortcuts: {
    textInput:
      "p-2 m-2 focus:(outline-none ring-indigo-500 border-indigo-500)  border-grey-300 shadow-sm rounded-md",
    ...
    textSubHeading: "text-2xl",
    textDescription:
      "text-sm text-gray-500 font-medium tracking-wider uppercase",
